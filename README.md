...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/siuba-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10658&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/siuba-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `siuba` can be installed with:

```
conda install siuba
```

It is possible to list all of the versions of `siuba` available on your platform with:
